...
#map0 = affine_map<()[s0] -> (s0 ceildiv 2)>
#map1 = affine_map<()[s0] -> (s0 * -2 + 3, 2)>
     ...
     ^bb0(%arg0: !hal.device, %arg1: index, %arg2: index, %arg3: index):
      ...
      builtin.module {
        func.func @matmul_static_dispatch_0_matmul_3x3x5() {
          ...
          %3 = affine.min #map1()[%workgroup_id_x]
          %4 = affine.apply #map2()[%workgroup_id_x]
          %subview = memref.subview %0[%4, 0] [%3, 5] [1, 1] : memref<3x5xf32> to memref<?x5xf32, strided<[5, 1], offset: ?>>
          %subview_0 = memref.subview %2[%4, 0] [%3, 3] [1, 1] : memref<3x3xf32> to memref<?x3xf32, strided<[3, 1], offset: ?>>
